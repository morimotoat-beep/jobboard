...
const TERMS: Partial<Record<Locale, LegalDoc>> = {
  ja: {
    ...
    sections: [
      {
        heading: "第1条（適用）",
        body: "本規約は、アカデミアノート Jobs（以下「当サイト」）の利用に関する条件を定めるものです。利用者は、本規約に同意のうえ当サイトを利用するものとします。",
      },
      {
        heading: "第2条（サービス内容）",
  ...
  en: {
    ...
    sections: [
      {
        heading: "1. Scope",
        body: "These terms govern the use of Academia Note Jobs (the \"Site\"). By using the Site, you agree to these terms.",
      },
      {
